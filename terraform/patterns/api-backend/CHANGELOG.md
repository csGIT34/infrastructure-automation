...
All notable changes to the api-backend pattern.
...
- Fix provider version conflict in provisioning workflow (82c82cd)
...
- Change default function_sku from Y1 to B1 (b142208)
...
- Fix Terraform provider syntax in pattern files (3f804b2)
