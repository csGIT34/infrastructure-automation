...
All notable changes to the keyvault pattern.
...
- Remove accidentally committed test files from keyvault pattern (6b901f0)
- Implement two-stage annual access review (1fe42d7)
- Add enable_access_review to keyvault optional config (3804cbc)
- Fix access review module format for Graph API (d318212)
- Add msgraph provider for access reviews to all patterns (5b24dae)
- Add pattern_name to keyvault_naming in all patterns (ff5ac34)
...
- Add missing conditional feature variables and modules to patterns (dbf4a9f)
- Remove unsupported auto_remove_on_deny argument from keyvault pattern (d0d6c44)
